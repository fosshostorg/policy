...
**** What are Categories?
     ...
     Each of our categories identifies items (steps, etc), we can
     report, for example whether and the degree to which this document
     is complete and correct and, for example, clearly and publicly
     state any known and long term risks or exceptions among them.
...
*** How To Change This Document           :VITAL:PUBLIC:EXAMPLE:PROCEDURE:
    ...
    # change comment/disclosure for README.org (Corwin, 20210515)
...
**** Update README.org
    ...
    * commit access or the ability to create a PR, e.g. to/for:
     ...
     1) Clone the [[https://github.com/fosshostorg/policy.git][public repo]] or navigate to ~README.org~ on the [[https://github.com/fosshostorg/policy/blob/main/README.org][web]].
     ...
     5) If you started but didn't finish this process please raise (or update your existing), e.g. [[https://github.com/fosshostorg/policy/issues][issue]] or etc.
